...
import basic from '../lesson02/imgs/basic.png'
import search from '../lesson02/imgs/search.png'
import sort from '../lesson02/imgs/sort.png'
import soccer from '../lesson02/imgs/soccer.png'
import text from '../lesson02/imgs/text.png'
  ...
  return (
    <section className="lesson02-slide" data-label="Course plan">
      ...
      <div className="slide-footer">
        <div className="sf-left"><span className="sf-dot" /> Algorithm #04 · Course plan</div>
      </div>
    </section>
  )
}
