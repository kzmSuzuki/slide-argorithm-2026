// Slide 00 — Attendance (座席確認)
import '../lesson02/lesson02Slides.css'
import qrUrl from './imgs/QR_4.png'
...
export default function Slide00() {
  return (
    <section className="lesson02-slide" data-label="Attendance">
      <div className="cover-meta">ALGORITHM / LESSON #04</div>
      <div
      ...
      <div className="slide-footer">
        <div className="sf-left"><span className="sf-dot" /> Algorithm #04</div>
      </div>
    </section>
  )
}
